export default function About() {
    return (
            <div >
                    ...
                    <div >
                        <img src="./src/assets/My_picture.jpg" alt="My picture" className='MyImg' />
                    </div>
                <br />
                <div className=''>
                    ...
                    <div >
                        <a className='aboutMeButtons1' href='./src/assets/Abdulrahman_Resume.pdf' target="blank" type = "application/pdf"><button>Download Resume</button></a>
